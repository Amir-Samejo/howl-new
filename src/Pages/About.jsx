                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="bg-img radius-10 md-mb50" data-background="assets/imgs/about/sq1.jpg" />
                            </div>
                            <div className="col-lg-8">
                                <div className="bg-img radius-10" data-background="assets/imgs/about/sq2.jpg" />
                            </div>
                            <div className="col-lg-4">
                        ...
                        <div className="row justify-content-around">
                            <div className="col-lg-5 valign md-mb50">
                                <div className="imgs mb-80">
                                    <div className="img1">
                                        <img src="assets/imgs/about/sq1.jpg" alt className="radius-10" />
                                    </div>
                                    <div className="img2">
                                        <img src="assets/imgs/about/sq2.jpg" alt className="radius-10" />
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        <div>
                                                            <div className="img circle-80">
                                                                <img src="assets/imgs/testim/1.jpg" alt className="circle-img" />
                                                            </div>
                                                        </div>
                                                        <div className="ml-30">
                                                            <div className="info">
